(custom-set-variables
 ...
 '(exec-path
   '("/home/ed/.local/bin" "/usr/local/sbin" "/usr/local/bin" "/usr/sbin" "/usr/bin" "/sbin" "/bin" "/usr/games" "/usr/local/games" "/snap/bin" "/home/ed/bin" "/snap/emacs/current/usr/libexec/emacs/26.3/x86_64-pc-linux-gnu"))
